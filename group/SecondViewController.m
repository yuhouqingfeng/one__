...
- (void)viewDidLoad {
    ...
    _tableView.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, W, 20)];
    _tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    [self.view addSubview:_tableView];
    
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(readArticleList1:) name:@"readArticleList1" object:nil];
...
-(void) readArticleList1:(NSNotification *)notification
{
