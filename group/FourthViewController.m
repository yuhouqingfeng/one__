...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(readArticleList3:) name:@"readArticleList3" object:nil];
...
-(void) readArticleList3:(NSNotification *)notification
{
